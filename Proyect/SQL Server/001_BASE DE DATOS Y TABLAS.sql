...
IdTienda int references TIENDA(IdTienda),
PrecioUnidadCompra decimal(10,0) default 0,
PrecioUnidadVenta decimal(10,0) default 0,
...
IdTienda int references TIENDA(IdTienda),
TotalCosto decimal(10,0) default 0,
...
IdProducto int references Producto(IdProducto),
Cantidad int,
PrecioUnitarioCompra decimal(10,0),
PrecioUnitarioVenta decimal(10,0),
TotalCosto decimal(10,0),
Activo bit default 1,
FechaRegistro datetime default getdate()
)
go
...
CantidadTotal int,
TotalCosto  decimal(10,0),
ImporteRecibido decimal(10,0),
ImporteCambio decimal(10,0),
Activo bit default 1,
FechaRegistro datetime default getdate()
)
go
