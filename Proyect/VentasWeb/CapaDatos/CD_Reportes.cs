...
namespace CapaDatos
{
    public class CD_Reportes
    {
        ...
        public List<ReporteVenta> ReporteVenta(DateTime FechaInicio, DateTime FechaFin, int IdTienda)
        {
            ...
            //public List<ReporteVentaExcel> ReporteVentaExcel(DateTime FechaInicio, DateTime FechaFin, int IdTienda)
            //{
            //    List<ReporteVentaExcel> lista = new List<ReporteVentaExcel>();
            ...
            //    using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            //    {
            //        SqlCommand cmd = new SqlCommand("usp_rptVentaExcel", oConexion);
            //        cmd.Parameters.AddWithValue("@FechaInicio", FechaInicio);
            //        cmd.Parameters.AddWithValue("@FechaFin", FechaFin);
            //        cmd.Parameters.AddWithValue("@IdTienda", IdTienda);
            //        cmd.CommandType = CommandType.StoredProcedure;
            ...
            //                while (dr.Read())
            //                {
            //                    lista.Add(new ReporteVentaExcel()
            //                    {
            //                        FechaVenta = dr["Fecha Venta"].ToString(),
            //                        NumeroDocumento = dr["Numero Documento"].ToString(),
            //                        TipoDocumento = dr["Tipo Documento"].ToString(),
            ...
            //        catch (Exception ex)
            //        {
            //            lista = new List<ReporteVentaExcel>();
            //        }
            //    }
